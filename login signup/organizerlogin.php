...
<body>
    ...
    <div class="login-center">
        <div class="login-container">
            ...
            <h1>Welcome back!</h1>
            <p class="subtitle">Enter your Credentials to access your organizer account</p>
            ...
            <form class="login-form" method="POST" action="../include/organizerlogin.php">
                <div class="form-group">
                    <input type="email" id="email" name="organizer_email" placeholder="Email address" required>
                </div>
                <div class="form-group password-container">
                    <input type="password" id="password" name="organizer_pwd" placeholder="Password" required>
                ...
                <div class="signup-link">
                    <p>Don't have an account? <a href="organizersignup.php">Sign up</a></p>
                </div>
            </form>
        </div>
    </div>
