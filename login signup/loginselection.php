...
<head>
    ...
    <link rel="stylesheet" href="loginselection.css">
</head>
<body>
    <nav class="navbar">
        <div class="logo">
    ...
    <div class="background-overlay">
        <div class="container">
            ...
            <div class="roles">
                <a href="artistlogin.php" class="role-card">
                    <h2>Artists</h2>
                    <p>
                        Sign in as an artist to manage your performances, update your profile, view bookings, and respond to event requests from organizers.
                    </p>
                </a>
                <a href="organizerlogin.php" class="role-card">
                    <h2>Organizer</h2>
                    <p>
                        Sign in as an organizer to find and book artists, manage your event schedules, and track your booking history for smooth event planning.
                    </p>
                </a>
            </div>
        </div>
