...
// Fetch confirmed booking requests for the logged-in organizer
$confirmed_bookings = [];
if (isset($_SESSION['organizer_id'])) {
    $stmt = $link->prepare("
        ...
        WHERE b.organizer_id = ? AND b.status = 'confirmed'
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['cancel_booking'])) {
    ...
    if ($stmt->execute()) {
        header("Location: organizerpending.php");
        exit();
    }
    $stmt->close();
}
...
<head>
    ...
    <link rel="stylesheet" href="organizerpending.css">
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <div class="welcome-message">
                <p>View and manage your confirmed bookings</p>
            </div>
            
            <div class="pending-container">
                <?php if (empty($confirmed_bookings)): ?>
                    <div class="no-bookings">
                        <p>You have no confirmed bookings at the moment.</p>
                    </div>
                <?php else: ?>
                        ...
                        <tbody>
                            <?php foreach ($confirmed_bookings as $booking): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="../html/payment.php?booking_id=<?php echo $booking['booking_id']; ?>" class="btn-pay">
