...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../css/musicband.css">
    ...
    <video autoplay loop muted plays-inline>
        <source src="../Image/Tomorrowland 2023 l Weekend I.mp4" type="video/mp4">
    </video>
    <nav class="navbar">
        <div class="logo">
        ...
        <div class="search-wrapper">
            <div class="section-title">ALL Music Bands</div>
            <form class="search-container">
                <input class="search-input" type="text" placeholder="Search Artists......." />
        ...
        <div class="singer-grid">
            ...
            <div class="singer-card">
                ...
                <img src="../Image/IMG_0723.JPG" alt="Hana Shafa" class="singer-image">
                <div class="singer-info">
                    <div class="singer-name">LineOne</div>
                    <div class="singer-description">
                        Specializes in Sinhalese pop,rock, and fusion music.Popular Sri Lankan band known for energetic performances
                    </div>
                    <div class="performance-info">
            ...
            <div class="singer-card">
                ...
                <img src="../Image/IMG_0758.JPG" alt="Shashika Nisansala" class="singer-image">
                <div class="singer-info">
            ...
            <div class="singer-card">
                ...
                <img src="../Image/IMG_0764.JPG" alt="Pradeep Rangana" class="singer-image">
                <div class="singer-info">
                    <div class="singer-name">DADY</div>
                    <div class="singer-description">
                        Specializes in Sinhalese pop,rock, and fusion music.Popular Sri Lankan band known for energetic performances
                    </div>
                    <div class="performance-info">
            ...
            <div class="singer-card">
                ...
                <img src="../Image/sandidapa.jpg" alt="Iraj" class="singer-image">
                <div class="singer-info">
                    <div class="singer-name">SANIDAPA</div>
                    <div class="singer-description">
                        Specializes in Sinhalese pop,rock, and fusion music.Popular Sri Lankan band known for energetic performances
                    </div>
                    <div class="performance-info">
                        Performs at concerts, festivals, and special events
                    </div>
                    <div class="book-now">
                        <button>Book Now</button>
            ...
            <div class="singer-card">
                ...
                <img src="../Image/sharaflash.jpg" alt="Centrigradz" class="singer-image">
                <div class="singer-info">
                    <div class="singer-name">SAHARAFLASH</div>
                    <div class="singer-description">
                        Specializes in Sinhalese pop,rock, and fusion music.Popular Sri Lankan band known for energetic performances
                    </div>
                    <div class="performance-info">
                        Performs at concerts, festivals, and corporate events
                    </div>
                    <div class="book-now">
                        <button>Book Now</button>
            ...
            <div class="singer-card">
                ...
                <img src="../Image/sunflower.jpg" alt="Nadeemal Perera" class="singer-image">
                <div class="singer-info">
                    <div class="singer-name">SUNFLOWER</div>
                    <div class="singer-description">
                        Specializes in Sinhalese pop,rock, and fusion music.Popular Sri Lankan band known for energetic performances
                    </div>
                    <div class="performance-info">
            ...
            <div class="singer-card">
                ...
                <img src="../Image/wayo.jpg" alt="Jaya Sri" class="singer-image">
                <div class="singer-info">
                    <div class="singer-name">WAYO</div>
                    <div class="singer-description">
            ...
            <div class="singer-card">
                ...
                <img src="../Image/AVATAR.jpg" alt="Shehan Mihiranga" class="singer-image">
                <div class="singer-info">
                    <div class="singer-name">AVATAR</div>
                    <div class="singer-description">
                        Beloved Sri Lankan artist known for her unique vocal style and emotional performances.
                    </div>
                    <div class="performance-info">
            ...
            <div class="singer-card">
                ...
                <img src="../Image/BEJI.jpg" alt="Kasun Kalhara" class="singer-image">
                <div class="singer-info">
                    <div class="singer-name">BEJI</div>
                    <div class="singer-description">
                        Beloved Sri Lankan artist known for her unique vocal style and emotional performances.
                    </div>
                    <div class="performance-info">
            ...
            <div class="singer-card">
                ...
                <img src="../Image/MARIANCE.jpg" alt="Bathiya & Santhush" class="singer-image">
                <div class="singer-info">
                    <div class="singer-name">MERIANCE</div>
                    <div class="singer-description">
                        Beloved Sri Lankan artist known for her unique vocal style and emotional performances.
                    </div>
                    <div class="performance-info">
