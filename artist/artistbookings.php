...
<head>
    ...
    <link rel="stylesheet" href="artistbookings.css">
            ...
            <div class="bookings-container">
                <table class="bookings-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="9" class="no-bookings">No confirmed bookings found</td>
                        </tr>
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($booking['participant_count']); ?></td>
